<template>
  <a-modal v-model="show" title="修改供应计划" @cancel="onClose" :width="800">
    ...
    <a-form :form="form" layout="vertical">
      <a-row :gutter="20">
        <a-col :span="12">
          <a-form-item label='供应计划标题' v-bind="formItemLayout">
            <a-input v-decorator="[
            'title',
        ...
        <a-col :span="12">
          <a-form-item label='供应计划状态' v-bind="formItemLayout">
            <a-select v-decorator="[
              'rackUp',
              { rules: [{ required: true, message: '请输入供应计划状态!' }] }
              ]">
        ...
        <a-col :span="24">
          <a-form-item label='供应计划内容' v-bind="formItemLayout">
